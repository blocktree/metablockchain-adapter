...
func (bs *MMUIBlockScanner) SaveLocalBlockHead(blockHeight uint64, blockHash string) error {
...
func (bs *MMUIBlockScanner) GetLocalBlockHead() (uint64, string, error) {
...
func (bs *MMUIBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *MMUIBlockScanner) GetLocalBlock(height uint64) (*Block, error) {
...
func (bs *MMUIBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *MMUIBlockScanner) DeleteUnscanRecord(height uint64) error {
...
func (bs *MMUIBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
